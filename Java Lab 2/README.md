...
<img width="591" height="219" alt="image" src="https://github.com/user-attachments/assets/919cb69f-f158-484d-afb7-9a11b7e94e04" />
...
<img width="627" height="225" alt="image" src="https://github.com/user-attachments/assets/ddafb9b8-b2cc-45e1-a57f-bebb5ba3d302" />
...
<img width="1004" height="456" alt="image" src="https://github.com/user-attachments/assets/2734c430-2069-4d81-887a-50bdc00cc26e" />
...
Используя разработанную сущность реализуйте схему, представленную на рисунке 2. <img width="864" height="348" alt="image" src="https://github.com/user-attachments/assets/b55a0304-e0de-4fea-bb3f-29b66474ddbc" />
...
1. Создать класс City
   - Поля: 
      String name
     Map<City, Integer> routes (город → стоимость)

2. Конструктор:
   - City(String name) - создает пустую карту маршрутов

3. Методы:
   - addRoute(City city, int cost) - добавляет маршрут
   - toString() - формат: "Название: город1:стоимость1, город2:стоимость2"

4. В main() создать схему:
   A → F(1), B(5), D(6)
   B → A(5), C(3)
   C → B(3), D(4)
   D → C(4), E(2), A(6)
   F → B(1), E(2)
   E → F(2)
<img width="664" height="633" alt="image" src="https://github.com/user-attachments/assets/a9044744-5499-44a9-b6b3-b0a57573d869" />
...
<img width="847" height="328" alt="image" src="https://github.com/user-attachments/assets/ab62436f-d969-42ce-8f6a-8eeeca47fae0" />
