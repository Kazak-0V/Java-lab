...
Алгоритм решения:
определить границы и проверить вхождение
...
Алгоритм решения:
сравнить три числа на равенство
...
Алгоритм решения:
проверить делится ли на 3 или 5 но не на оба сразу
...
Алгоритм решения:
найти наибольшее из двух чисел первого со вторым
найти наибольшее из наибольшего между первым и вторым и  третьим
...
Алгоритм решения:
сложить и заменить определенный диапазон на 20
...
Алгоритм решения:
перечислить все числа от 0 до заданного
...
Алгоритм решения:
вывести числа до х с шагом в 2
...
Алгоритм решения:
Два вложенных цикла: по строкам и по столбцам
В каждой ячейке печатаем звездочку
...
Алгоритм решения:
Для каждой строки: сначала печатаем пробелы, потом звездочки
Количество пробелов уменьшается, звездочек - увеличивается
Выравнивание получается за счет пробелов
...
Как только нашли - возвращаем индекс, иначе - возвращаем -1
...
Сравниваем модули элементов между собой
Запоминаем элемент с наибольшим модулем
...
Алгоритм решения:
Создаем новый массив (размер = оба массива вместе)
Копируем: сначала часть первого массива до позиции вставки
Потом весь второй массив
Потом остаток первого массива
...
Заполняем его элементами из исходного массива в обратном порядке
...
Алгоритм решения:
Сначала проходим по массиву и считаем сколько раз встречается число
Создаем массив именно такого размера
Вторым проходом заполняем этот массив индексами где встречается число